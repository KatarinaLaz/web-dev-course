...
app.post("/submit", (req, res) => {
  let firstWord = adj[Math.floor(Math.random()*adj.length)];
  let secondWord = noun[Math.floor(Math.random()*noun.length)];
  res.render("index.ejs", {adj: firstWord, noun: secondWord})
